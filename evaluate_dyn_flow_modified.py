...
from lib.bin.dyn_rnn_flow_modified import DynRNN_gen_model
from lib.bin.load_models_modified import ModelLoader
...
def main():
    ...
    for iclass in range(0, num_classes):
        ...
        weight_iclass = len(true_preds_iclass) #np.count_nonzero(np.array(model_preds_iclass == true_preds_iclass)) #/ len(true_preds_iclass)
