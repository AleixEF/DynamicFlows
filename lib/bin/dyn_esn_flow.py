...
class DynESN_gen_model(nn.Module):
    ...
    def predict_sequences(self, class_number, evalloader, mode="test", eval_logfile_path=None):
        ...
        print("------------------------------ Evaluation begins --------------------------------- \n", file=orig_stdout)
        print("Config: {} \n".format(self.options["dyn_esn_flow"]))
        print("\n Config: {} \n".format(self.options["dyn_esn_flow"]), file=orig_stdout)
        ...
        print("Config: {}".format(self.options["dyn_esn_flow"]))
