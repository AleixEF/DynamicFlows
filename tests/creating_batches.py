...
# -*- coding: utf-8 -*-
"""
Created on Wed Sep  1 09:19:01 2021
...
for i in range(n_train_batches):
    ...
    train_batch_filename = "".join([folder2save, 'train', 
                                    str(i), '.npy']) 
...
for i in range(n_validation_batches):
    ...
    val_batch_filename = "".join([folder2save, 'val', 
                                    str(i), '.npy']) 
...
print("relative diff")
print(np.abs((expected_frames-approx_expected_frames) / expected_frames))